package zohocrm;
	...
	driver.findElement(By.xpath("//input[@name='property(Other Street)']")).sendKeys("chamrajpet");

	driver.findElement(By.xpath("//input[@name='property(Other City)']")).sendKeys("bangalore");

	driver.findElement(By.xpath("//input[@name='property(Other State)']")).sendKeys("karnataka");

	driver.findElement(By.xpath("//input[@name='property(Other Country)']")).sendKeys("India");

	driver.findElement(By.xpath("//input[@name='property(Other Zip)']")).sendKeys("560018");
